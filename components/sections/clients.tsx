    ...
    <div className="py-24 border-y border-white/[0.05] relative overflow-hidden group">
      ...
      <div className="relative z-10 mb-16 text-center flex flex-col items-center gap-6">
        ...
        <p className="text-white/40 text-xl md:text-2xl font-normal tabular-nums flex flex-wrap items-center justify-center gap-x-2">
          <span>Более <span className="text-white font-medium min-w-[5.2ch] inline-block text-center"><AnimatedNumber value={20000} duration={1500} /></span> проектов</span>
          <span>выполнено за <span className="text-white font-medium min-w-[2.2ch] inline-block text-center"><AnimatedNumber value={18} duration={1500} /></span> лет</span>
        </p>
      </div>

...
const faqs = [
    {
        q: "Не станет ли плёнка фиолетовой и не отслоится ли через пару лет?",
        a: "Основа — наноуглерод, а не краситель. Углерод химически инертен: он не может выцвести или дать фиолетовый оттенок. На адгезию действует бессрочная гарантия производителя.",
    },
    {
        q: "Не повлияет ли плёнка на лобовом на проекцию, камеры и видимость ночью?",
        a: "Оптическая мутность бронеплёнки — 0.6%: невидима для глаза, камер ADAS и проекции HUD.",
    },
    {
        q: "Не будет ли проблем с ГИБДД и техосмотром?",
        a: "Лобовое — только атермальная плёнка с ~80% светопропускания, строго по ГОСТ 32565-2013. Замер люксметром при вас перед выдачей. Задняя полусфера законна в любой степени затемнения.",
    },
    {
        q: "Сколько времени займёт работа?",
        a: "Задняя полусфера — 45 минут. Полная тонировка — 2 часа. Работа ведётся строго по записи, без очередей.",
    },
    {
        q: "Как мне убедиться, что всё сделано правильно?",
        a: "Будет дополнено позже.",
    },
    {
        q: "Почему у вас дороже, чем в других студиях?",
        a: "Вы платите один раз — без переклейки через два года и без доработок. Разница в чеке закрывается отсутствием повторных обращений: это последняя тонировка на весь срок владения автомобиля. Дешёвая плёнка с переклейкой обходится дороже.",
    },
];
